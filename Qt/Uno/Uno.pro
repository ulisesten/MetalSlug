...
UBUNTU_TRANSLATION_DOMAIN="uno.username"
...
aptest.commands = bash $$PWD/Uno/tests/autopilot/run
aptest.depends  = sub-Uno

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Uno/tests/unit
unittest.depends  = sub-Uno
