...
void clarkShootArr(SDL_Rect torzo[9]){
    torzo[0].x=19;   torzo[0].y=50;//Disparando adelante------------
    torzo[0].w=55;   torzo[0].h=30;

    torzo[1].x=85;   torzo[1].y=50;
    ...
    torzo[4].x=206;  torzo[4].y=50;
    torzo[4].w=50;   torzo[4].h=30;

    torzo[5].x=303;  torzo[5].y=50;
    torzo[5].w=45;   torzo[5].h=30;

    torzo[6].x=352;  torzo[6].y=50;
    torzo[6].w=45;   torzo[6].h=30;

    torzo[7].x=401;  torzo[7].y=48;
    torzo[7].w=40;   torzo[7].h=30;

    torzo[8].x=449;  torzo[8].y=49;
    torzo[8].w=35;   torzo[8].h=30;

    torzo[9].x=498;  torzo[9].y=50;
